...
import "./styles/AdminDashboard.css";
import { Toaster, toast } from "sonner";
import { LogOut, Cloud } from "lucide-react"; // Added Cloud icon for Deco tab
...
function AdminDashboard({ userData, onLogout, onBack }) {
  ...
  const renderDecoTab = () => (
    <div className="adm-deco-tab">
      <div className="adm-section-header">
        <h2>Deco System Integration</h2>
      </div>

      <div className="adm-deco-login-card">
        <h3>Login to Deco</h3>
        <div className="adm-form-group">
          <label>Username</label>
          <input
        ...
        >
          {decoLoading ? "Logging in..." : "Login to Deco"}
        </button>
        {decoToken && (
          <p style={{ color: "green", marginTop: 10 }}>✅ Logged in to Deco</p>
        )}
      </div>

      {decoToken && (
        <>
          <div className="adm-deco-actions">
            <div className="adm-deco-status-section">
              <h3>Deco Availability</h3>
              <button
                className="adm-btn-secondary"
              ...
              {decoStatus !== null && (
                <p>
                  Deco is{" "}
                  <strong>{decoStatus ? "Available" : "Not Available"}</strong>
                </p>
              )}
            </div>

            <div className="adm-deco-fetch-section">
              <h3>Fetch Trainees</h3>
              <div className="adm-form-group" style={{ width: "200px" }}>
              ...
              <button
                ...
                disabled={decoLoading}
              >
                {decoLoading ? "Fetching..." : "Fetch & Store Trainees"}
              </button>
            </div>
          </div>

          {decoMessage && (
            <div className="adm-deco-message">
              <p>{decoMessage}</p>
            </div>
          )}
        </>
        ...
        <div className="adm-modal-body">
          <div className="adm-upload-instructions">
            ...
            <ul>
              ...
              <li>
                Roles: <code>trainee</code>, <code>ta</code>,{" "}
                <code>manager</code>, <code>hr</code>, <code>admin</code>, <code>interviewer</code>
              </li>
              <li>
                <a href="/template/user_bulk_template.xlsx" download='user_bulk_template.xlsx'>
                  Download Excel template
  ...
  return (
    <div className="adm-dashboard">
      ...
      <div className="adm-main-content">
        ...
        {activeTab === "users" && renderUsersTab()}
        {activeTab === "statistics" && renderStatisticsTab()}
        {activeTab === "deco" && renderDecoTab()}  {/* NEW */}
      </div>
