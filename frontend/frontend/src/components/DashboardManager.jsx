...
import {
  ...
  BookOpen, Code, Cpu, Server, Wrench, Info, Loader
} from "lucide-react";
import {
        ...
        {selectedJobForSearch && (
          <>
            ...
            <div className="table-actions">
              ...
              <button onClick={downloadFilteredSearch} disabled={!filtered.length} className="btn-secondary"><Download size={16} /> Download Filtered</button>
            </div>
    ...
    <div className="chatbot-tab">
      <div className="chat-header">
        <div className="chat-session-controls">
          ...
          <button onClick={createNewChatSession} className="btn-secondary"><PlusCircle size={16} /> New Chat</button>
        </div>
